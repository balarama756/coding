...
const gf = new GiphyFetch("Efe7JBKJbbAlRjiNvPEmPsuzmpemCee6");
    ...
    return (
        <div ref={gridRef} className='w-full mt-3'>
            <input
                ...
                className='border border-stroke dark:border-strokedark rounded-md p-2 w-full mb-2 outline-none bg-transparent' value={value}
                onChange={(e) => {
            ...
            <div
                className='h-48 overflow-auto no-scrollbar'>
             {gifs.length > 0 ?   <Grid 
                ...
                <div className='flex flex-col items-center justify-center h-full space-y-2'>
                    ...
                    <span className='text-xl text-body  font-semibold'>Please search for any Gif</span>
                    </div>}
